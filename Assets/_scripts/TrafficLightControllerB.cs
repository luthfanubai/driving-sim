...
/// <summary>
/// Controller Lampu lalu lintas untuk sisi timur dan barat
/// </summary>
public class TrafficLightControllerB : MonoBehaviour {
	...
	void Start() {
		...
		rend.materials[3].shader = shaderOn; //inisiasi lampu hijau menyala terlebih dahulu
